...
def process_event_queue():
    while True:
        try:
            ...
            create_event(event_data['bot_instance'], event_data['event_name'], event_data['event_datetime'], event_data['channel_id'])
...
def enqueue_event(bot, event_name, event_datetime, channel_id):
    try:
        event_queue.put({
...
# Dequeue/deletion taken care of by goose_king.py
